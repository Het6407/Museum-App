...
public class UserServiceImpl implements UserService {
	...
	public void saveUser(User user) {
		...
		if (user.getId() == null) {
			if (userRepo != null && userRepo.getEmail() != null && !Strings.isEmpty(userRepo.getEmail())
					&& userRepo.getEmail().equals(user.getEmail())) {
	...
	public void editUser(User user1) {
		...
		if(user1.getId() != null) {
			User userImage = userRepository.findById(user1.getId()).get();
			if(userImage != null) {
				user1.setProfileImage(userImage.getProfileImage());
			}
		}
	...
	public void editProfile(User user2) {
		...
		if (user2.getId() != null) {
			User setMuseum = userRepository.findById(user2.getId()).get();
			if (setMuseum != null) {
				user2.setMuseums(setMuseum.getMuseums());
			}
		}
		
//		if(user2.getId() != null) {
//			User userImage = userRepository.findById(user2.getId()).get();
//			if(userImage != null) {
//				user2.setProfileImage(userImage.getProfileImage());
//			}
//		}
